...
public sealed class HelpTextAccuracyTests
{
    ...
    [Theory]
    [InlineData("MainWindow.xaml", "Genel Bakış", "Günlük Takip", "Öğrenciler", "Anasınıfı", "Kartlar", "Kasa", "Yemek Hakedişleri", "Takvim / Tatil", "Sicil Aktar", "Tanımlar", "Cihazlar / Turnikeler", "Kart Yükleme Durumu", "SMS Merkezi", "Raporlar", "Ayarlar", "Kısayollar  F1", "Öğrenci, kart, sınıf, tarih veya modül ara...")]
