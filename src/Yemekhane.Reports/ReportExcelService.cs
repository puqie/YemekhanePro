...
public sealed class ReportExcelService : IExcelService
{
    ...
    private static readonly Dictionary<ReportType, ReportDefinition> Definitions = new()
    {
        ...
        [ReportType.DailyCash] = Def("Günlük Kasa Raporu", C("Tarih", ColumnKind.Date, Date, 20), C("Öğrenci No", ColumnKind.Text, x => x.StudentNo, 14), C("Ad Soyad", ColumnKind.Text, Name, 24), C("Kart", ColumnKind.Text, x => x.CardNo, 16), C("Açıklama", ColumnKind.Text, x => x.Description, 32), C("Durum", ColumnKind.Text, x => x.Status, 16), C("Tutar", ColumnKind.Decimal, x => x.Amount, 14)),
        [ReportType.Income] = Def("Gelir Raporu", C("Tarih", ColumnKind.Date, Date, 20), C("Öğrenci No", ColumnKind.Text, x => x.StudentNo, 14), C("Ad Soyad", ColumnKind.Text, Name, 24), C("Kart", ColumnKind.Text, x => x.CardNo, 16), C("Açıklama", ColumnKind.Text, x => x.Description, 32), C("Durum", ColumnKind.Text, x => x.Status, 16), C("Tutar", ColumnKind.Decimal, x => x.Amount, 14)),
        [ReportType.Sms] = Def("SMS Raporu", C("Tarih", ColumnKind.Date, Date, 20), C("Öğrenci No", ColumnKind.Text, x => x.StudentNo, 14), C("Ad Soyad", ColumnKind.Text, Name, 24), C("Açıklama", ColumnKind.Text, x => x.Description, 40), C("Durum", ColumnKind.Text, x => x.Status, 16)),
        [ReportType.Turnstile] = Def("Turnike Raporu", C("Tarih", ColumnKind.Date, Date, 20), C("Öğrenci No", ColumnKind.Text, x => x.StudentNo, 14), C("Ad Soyad", ColumnKind.Text, Name, 24), C("Kart", ColumnKind.Text, x => x.CardNo, 16), C("Cihaz", ColumnKind.Text, x => x.Device, 20), C("Karar", ColumnKind.Text, x => x.Decision, 14), C("Sonuç", ColumnKind.Text, x => x.Status, 16), C("Açıklama", ColumnKind.Text, x => x.Description, 28)),
        [ReportType.DeniedAccess] = Def("Reddedilen Geçişler Raporu", C("Tarih", ColumnKind.Date, Date, 20), C("Öğrenci No", ColumnKind.Text, x => x.StudentNo, 14), C("Ad Soyad", ColumnKind.Text, Name, 24), C("Kart", ColumnKind.Text, x => x.CardNo, 16), C("Öğün", ColumnKind.Text, x => x.MealType, 14), C("Cihaz", ColumnKind.Text, x => x.Device, 20), C("Neden", ColumnKind.Text, x => x.Status, 24)),
        [ReportType.CardMovements] = Def("Kart Hareketleri Raporu", C("Tarih", ColumnKind.Date, Date, 20), C("Öğrenci No", ColumnKind.Text, x => x.StudentNo, 14), C("Ad Soyad", ColumnKind.Text, Name, 24), C("Sınıf", ColumnKind.Text, x => x.Class, 12), C("Kart", ColumnKind.Text, x => x.CardNo, 16), C("Durum", ColumnKind.Text, x => x.Status, 16), C("Açıklama", ColumnKind.Text, x => x.Description, 28)),
        [ReportType.HolidayTransfer] = Def("Tatil ve Aktarım Raporu", C("Tarih", ColumnKind.Date, Date, 14), C("Öğrenci No", ColumnKind.Text, x => x.StudentNo, 14), C("Ad Soyad", ColumnKind.Text, Name, 24), C("Öğün", ColumnKind.Text, x => x.MealType, 14), C("Adet", ColumnKind.Integer, x => x.MealCount, 10), C("Durum", ColumnKind.Text, x => x.Status, 16), C("Açıklama", ColumnKind.Text, x => x.Description, 32))
    };
