...
public sealed class ReportsViewModel : ObservableObject, IDisposable
{
    ...
    private static readonly Dictionary<ReportType, Definition[]> Definitions = new()
    {
        ...
        [ReportType.Turnstile] = [C("Date", "TARİH", "timestamp", 150), C("StudentNo", "NO", "studentNo", Auto), C("Name", "AD SOYAD", "firstName", Auto), C("CardNo", "KART", "cardNo", Auto), C("Device", "CİHAZ", "device", Auto), C("Decision", "KARAR", "decision", 100), C("Status", "SONUÇ", "status", 110), C("Description", "AÇIKLAMA", null, Star)],
        [ReportType.DeniedAccess] = [C("Date", "TARİH", "timestamp", 150), C("StudentNo", "NO", "studentNo", Auto), C("Name", "AD SOYAD", "firstName", Auto), C("CardNo", "KART", "cardNo", Auto), C("MealType", "ÖĞÜN", "mealType", 110), C("Device", "CİHAZ", "device", Auto), C("Status", "NEDEN", "status", Star)],
